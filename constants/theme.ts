const themeConfig = [
  {
    ...
    _id: "1",
    description: "A timeless color scheme that works well in any setting.",
    colors: ["#292f4c", "#1c1f3b", "#747171", "#0073ea", "#133774", "#ffffff"],
  },
  {
    //green
    name: "Lavish Green",
...
const pulseHeightConfig = {
  sm: "2.5rem",
  md: "3rem",
  lg: "3.5rem",
};
export { themeConfig, pulseHeightConfig };
